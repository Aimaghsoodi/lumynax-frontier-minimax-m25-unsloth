...
[🤗 Weights & model card on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-frontier-minimax-m25-unsloth) · [abteex.com](https://abteex.com) · [lumynax.com](https://lumynax.com) · [Monorepo](https://github.com/Aimaghsoodi/lumynax-release)

---

This GitHub repo mirrors the **runtime scaffolding** (quickstart, requirements, Modelfile, Space, docs). The model **weights** are published on Hugging Face at `AbteeXAILab/lumynax-frontier-minimax-m25-unsloth` — they exceed GitHub's per-file limit.

```bash
hf download AbteeXAILab/lumynax-frontier-minimax-m25-unsloth --local-dir lumynax-frontier-minimax-m25-unsloth
cd lumynax-frontier-minimax-m25-unsloth && pip install -r requirements.txt && python quickstart.py --interactive
# Or:  pip install lumynax && lumynax run lumynax-frontier-minimax-m25-unsloth -i
```
